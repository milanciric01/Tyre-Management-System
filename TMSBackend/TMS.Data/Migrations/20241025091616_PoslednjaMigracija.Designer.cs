...
namespace TMS.Data.Migrations
{
    ...
    [Migration("20241025091616_PoslednjaMigracija")]
    partial class PoslednjaMigracija
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("TMS.Data.Models.TyreProduction", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            MachineNumber = "M001",
                            OperatorId = 1,
                            ProductionDate = new DateTime(2024, 10, 25, 11, 16, 15, 267, DateTimeKind.Local).AddTicks(366),
                            ProductionShift = 0,
                            Quantity = 100,
                            TyreCode = "T123"
                        },
                        new
                        {
                            ...
                            MachineNumber = "M002",
                            OperatorId = 1,
                            ProductionDate = new DateTime(2024, 10, 25, 11, 16, 15, 267, DateTimeKind.Local).AddTicks(505),
                            ProductionShift = 2,
                            Quantity = 150,
                            TyreCode = "T124"
                        });
            ...
            modelBuilder.Entity("TMS.Data.Models.TyreSales", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateOfSale = new DateTime(2024, 10, 25, 11, 16, 15, 267, DateTimeKind.Local).AddTicks(623),
                        ...
                        {
                            Id = 2,
                            DateOfSale = new DateTime(2024, 10, 25, 11, 16, 15, 267, DateTimeKind.Local).AddTicks(637),
            ...
            modelBuilder.Entity("TMS.Data.Models.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Password = "$2a$11$4qYJIPcRXEniahQgvbqQ4uRjXIO4KKfkYUi3yn7D/aMCktQwxfk4m",
                            UserRole = 0,
                            Username = "operator1"
                        },
                        new
                        {
                            Id = 2,
                            Password = "$2a$11$7NulZNeFtocpkZwfk63jIePwup6es75OQ26rQAIEzu52KfqvZTy3K",
                            UserRole = 1,
                        ...
                        {
                            Id = 3,
                            Password = "$2a$11$PCOD8an6zskXnjaebHpf6ecQt/ECzbCmM2jF0fPXucNZW/LQZeoam",
                            UserRole = 2,
                            Username = "leader1"
                        });
                });
